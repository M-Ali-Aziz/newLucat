...
class News extends AbstractTemplateAreabrick
{
    ...
    public function action(Info $info)
    {
        ...
        $targetGroup = $this->getDocumentTag($info->getDocument(), 'select', 'targetGroup')->getData();
        ...
        $info->getView()->heading    = $this->getDocumentTag($info->getDocument(), 'input', 'heading')->getData();
