...
namespace NewLucatBundle\Command;
 ...
 *
 */
class NewLucatSyncCommand extends AbstractCommand
{
    protected function configure()
    {
        $this
            ->setName('newlucat:sync')
            ->setDescription('New Lucat Sync');
    }
